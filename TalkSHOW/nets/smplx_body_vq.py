...
class TrainWrapper(TrainWrapperBaseClass):
    ...
    def init_params(self):
        ...
        body_pose = round((63 - 24) * scale) # 为什么-24
    ...
    def __call__(self, bat):
        ...
        poses = poses[:, self.c_index, :] # 把129(39body + 90hand)和165（75（jaw3,le3, re3, go3, bodypose63） + 90hand）做映射
        gt_poses = poses.permute(0, 2, 1) #(128, 88, 129)
