...
def render_mesh_helper(mesh, t_center, rot=np.zeros(3), tex_img=None, v_colors=None,
                       ...
                       y=0.7, z=1, camera='o', r=None, infer_cfg=None, idx=None):
    ...
    if not texture_rendering:
        ...
        # if infer_cfg.save_mesh.save_obj:
        #     save_mesh_dir = os.path.join(infer_cfg.save_root_path, infer_cfg.file_name, 'mesh')
        #     os.makedirs(save_mesh_dir, exist_ok=True)
        #     output_name=os.path.join(save_mesh_dir, str(idx) + '.obj')
        #     export_mesh(tri_mesh, output_name, file_type='obj')
