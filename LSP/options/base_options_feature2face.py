...
class BaseOptions():
    ...
    def initialize(self):  
        ...
        self.parser.add_argument('--single_name', type=str, default='TestRender', help='name of the experiment that dosent require n_prev_frame')        
        ...
        self.parser.add_argument('--loadSize_h', type=int, default=512, help='scale images to this size')
        self.parser.add_argument('--loadSize_w', type=int, default=512, help='scale images to this size')
        self.parser.add_argument('--mask_w', type=int, default=112, help='mask images in both sides of width dimention')


        self.parser.add_argument('--fineSize', type=int, default=512, help='then crop to this size')
        self.parser.add_argument('--input_nc', type=int, default=1, help='# of input image channels')      
        self.parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')  
        self.parser.add_argument('--n_prev_frames', type=int, default=0, help='# of output image channels')  
              
                                 
        # setting inputs
        self.parser.add_argument('--is_val', default=0, type=int, help='for validation dataset')
        ...
        self.parser.add_argument('--wandb_project_name', type=str, default='proj-face-video', help='specify wandb project name')
    ...
    def parse(self, save=True):
        ...
        if self.isTrain:
            ...
            train_datasets = self.opt.train_dataset_names.split(',')
            self.opt.train_dataset_names = []
            for name in train_datasets:
                self.opt.train_dataset_names.append(name)
