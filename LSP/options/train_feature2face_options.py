...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--train_dataset_names', type=str, default='Obama1')
        self.parser.add_argument('--validate_dataset_names', type=str, default='')
        ...
        self.parser.add_argument('--update_html_freq', type=int, default=400, help='frequency of saving training results to html')
        self.parser.add_argument('--print_freq', type=int, default=10, help='frequency of showing training results on console(epochs)')
        self.parser.add_argument('--save_latest_freq', type=int, default=500, help='frequency of to save the latest results(iterations)')
        ...
        self.parser.add_argument('--n_epochs_warm_up', type=int, default=0, help='number of epochs warm up')
        ...
        self.parser.add_argument('--n_epochs_student', type=int, default=1e9, help='number of epochs to linearly decay learning rate to zero')
